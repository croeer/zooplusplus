...
export function MyAccount() {
    ...
    setRedrawQr(false); setBeneficiary(event.target.value); }}/>
            ...
            <Button variant="contained" endIcon={<QrCode2Icon />} onClick={() => setRedrawQr(true)} > QR-Code testen</Button>
            <QrCode iban={iban} bic={bic} beneficiary={beneficiary} amount={666.67} invoiceNumber="1234" customerName={customerName} customerNumber={customerNumber} redraw={redrawQr}/>
