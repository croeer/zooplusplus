...
namespace zooplusplus
{
    public class QrGenerator
    {
        ...
        public string GenerateGiroCodeAscii(ZooplusInvoiceDto billDto)
        {
            Girocode generator = new Girocode(ZOOPLUS_IBAN, ZOOPLUS_BIC, ZOOPLUS_NAME, (decimal)billDto.Amount, $"ReNr {billDto.InvoiceNumber}, KdNr 123456 V Name");
